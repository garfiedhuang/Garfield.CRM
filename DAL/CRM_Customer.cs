...
namespace Garfield.DAL
{
    ...
    public partial class CRM_Customer
    {
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
        {
            ...
            strSql.Append(" * FROM CRM_Customer where 1=1 ");
        ...
        public bool ToImport()
        {
            ...
            strSql0.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [isDelete]=0 WHERE [isDelete] is null");
            strSql1.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [industry_id] = (select id from Param_SysParam where params_name=CRM_Customer.industry and parentid=8)");
            strSql2.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [CustomerType_id] = (select id from Param_SysParam where params_name=CRM_Customer.CustomerType and parentid=1)");
            strSql3.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [CustomerLevel_id] = (select id from Param_SysParam where params_name=CRM_Customer.CustomerLevel and parentid=2)");
            strSql4.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [CustomerSource_id] = (select id from Param_SysParam where params_name=CRM_Customer.CustomerSource and parentid=3)");
            strSql5.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [Provinces_id] = (select id from Param_City where City=CRM_Customer.Provinces)");
            strSql6.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [City_id] = (select id from Param_City where City=CRM_Customer.City)");
            strSql7.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [Department_id] = (select id from hr_department where d_name=CRM_Customer.Department)");
            strSql8.Append("UPDATE [Garfield_CRM_V1].[dbo].[CRM_Customer] SET [Employee_id] = (select ID from hr_employee where name=CRM_Customer.Employee)");

	...
	public partial class CRM_Contact
	{
		...
		public int Add(Garfield.Model.CRM_Contact model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@C_mob", MySqlDbType.VarChar,250),
		...
		public Garfield.Model.CRM_Contact GetModel(int id)
		{
            ...
            strSql.Append("select id,C_name,C_sex,C_department,C_position,C_birthday,C_tel,C_fax,C_email,C_mob,C_QQ,C_add,C_hobby,C_remarks,C_customerid,C_customername,C_createId,C_createDate,isDelete,Delete_time from CRM_Contact ");
            strSql.Append(" where id=@id");
		...
		public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
		{
            ...
            strSql.Append(" * FROM CRM_Contact where 1=1 ");

...
namespace Garfield.DAL
{
	...
	public partial class Param_SysParam
	{
		...
		public Garfield.Model.Param_SysParam GetModel(int id)
		{
            ...
            strSql.Append("select id,parentid,params_name,params_order,Create_id,Create_date,Update_id,Update_date from Param_SysParam ");
            strSql.Append(" where id=@id");
		...
		public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
		{
            ...
            strSql.Append(" * FROM Param_SysParam where 1=1 ");

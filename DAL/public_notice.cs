...
namespace Garfield.DAL
{
	...
	public partial class public_notice
	{
		...
		public int Add(Garfield.Model.public_notice model)
		{
			...
			MySqlParameter[] parameters = {
					new MySqlParameter("@notice_title", MySqlDbType.VarChar,250),
		...
		public Garfield.Model.public_notice GetModel(int id)
		{
            ...
            strSql.Append("select id,notice_title,notice_content,create_id,create_name,dep_id,dep_name,notice_time from public_notice ");
            strSql.Append(" where id=@id");
		...
		public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
		{
            ...
            strSql.Append(" * FROM public_notice where 1=1 ");

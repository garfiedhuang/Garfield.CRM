...
<head>
    ...
    <script type="text/javascript">
        ...
        function toolbar() {
            ...
            filters: [
                { id: 'filter-home', title: '桌面', bodyStyle: 'filter-home', handler: function () { f_addTab('tabitem1', '桌面', 'personal/portal.aspx') } },
        ...
        function show_welcome(item) {
            if (getCookie("garfield_crm_show_wellcome") == 1 || item == 1) {
                var dialog = $.ligerDialog.open({
                    url: "welcome.htm", width: 800, height: 500, title: "欢迎使用", buttons: [
                            {
                                text: '关闭', onclick: function (item, dialog) {
                                    dialog.close();
                                }

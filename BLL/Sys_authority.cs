...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Sys_authority dal=new Garfield.DAL.Sys_authority();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Sys_authority GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			...
			return (Garfield.Model.Sys_authority)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_authority> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_authority> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Sys_authority> modelList = new List<Garfield.Model.Sys_authority>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Sys_authority model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Sys_authority();

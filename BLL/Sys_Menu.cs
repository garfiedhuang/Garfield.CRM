...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Sys_Menu dal=new Garfield.DAL.Sys_Menu();
		public Sys_Menu()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Sys_Menu GetModelByCache(int Menu_id)
		{
			...
			return (Garfield.Model.Sys_Menu)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_Menu> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_Menu> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Sys_Menu> modelList = new List<Garfield.Model.Sys_Menu>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Sys_Menu model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Sys_Menu();

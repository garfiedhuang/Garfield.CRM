...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.CRM_invoice dal=new Garfield.DAL.CRM_invoice();
		public CRM_invoice()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.CRM_invoice GetModelByCache(int id)
		{
			...
			return (Garfield.Model.CRM_invoice)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_invoice> GetModelList(string strWhere)
		{

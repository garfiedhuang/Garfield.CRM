...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.CRM_Contact dal=new Garfield.DAL.CRM_Contact();
		public CRM_Contact()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.CRM_Contact GetModelByCache(int id)
		{
			...
			return (Garfield.Model.CRM_Contact)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_Contact> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_Contact> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.CRM_Contact> modelList = new List<Garfield.Model.CRM_Contact>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.CRM_Contact model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.CRM_Contact();

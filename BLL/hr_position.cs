...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.hr_position dal=new Garfield.DAL.hr_position();
		public hr_position()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.hr_position GetModelByCache(int id)
		{
			...
			return (Garfield.Model.hr_position)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.hr_position> GetModelList(string strWhere)
		{

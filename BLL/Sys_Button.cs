...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Sys_Button dal=new Garfield.DAL.Sys_Button();
		public Sys_Button()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Sys_Button GetModelByCache(int Btn_id)
		{
			...
			return (Garfield.Model.Sys_Button)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_Button> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_Button> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Sys_Button> modelList = new List<Garfield.Model.Sys_Button>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Sys_Button model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Sys_Button();

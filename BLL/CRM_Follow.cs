...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.CRM_Follow dal=new Garfield.DAL.CRM_Follow();
		public CRM_Follow()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.CRM_Follow GetModelByCache(int id)
		{
			...
			return (Garfield.Model.CRM_Follow)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_Follow> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_Follow> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.CRM_Follow> modelList = new List<Garfield.Model.CRM_Follow>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.CRM_Follow model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.CRM_Follow();

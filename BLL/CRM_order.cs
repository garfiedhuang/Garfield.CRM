...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.CRM_order dal=new Garfield.DAL.CRM_order();
		public CRM_order()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.CRM_order GetModelByCache(int id)
		{
			...
			return (Garfield.Model.CRM_order)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_order> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_order> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.CRM_order> modelList = new List<Garfield.Model.CRM_order>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.CRM_order model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.CRM_order();

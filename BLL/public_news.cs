...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.public_news dal=new Garfield.DAL.public_news();
		public public_news()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.public_news GetModelByCache(int id)
		{
			...
			return (Garfield.Model.public_news)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.public_news> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.public_news> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.public_news> modelList = new List<Garfield.Model.public_news>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.public_news model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.public_news();

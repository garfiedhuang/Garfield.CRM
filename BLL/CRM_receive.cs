...
namespace Garfield.BLL
{
    ...
    {
        private readonly Garfield.DAL.CRM_receive dal = new Garfield.DAL.CRM_receive();
        public CRM_receive()
        { }
        #region  Method
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Garfield.Model.CRM_receive GetModelByCache(int id)
        {
            ...
            return (Garfield.Model.CRM_receive)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Garfield.Model.CRM_receive> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Garfield.Model.CRM_receive> DataTableToList(DataTable dt)
        {
            List<Garfield.Model.CRM_receive> modelList = new List<Garfield.Model.CRM_receive>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Garfield.Model.CRM_receive model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Garfield.Model.CRM_receive();

...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.CRM_Customer dal=new Garfield.DAL.CRM_Customer();
		public CRM_Customer()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.CRM_Customer GetModelByCache(int id)
		{
			...
			return (Garfield.Model.CRM_Customer)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_Customer> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_Customer> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.CRM_Customer> modelList = new List<Garfield.Model.CRM_Customer>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.CRM_Customer model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.CRM_Customer();

...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Param_City dal=new Garfield.DAL.Param_City();
		public Param_City()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Param_City GetModelByCache(int id)
		{
			...
			return (Garfield.Model.Param_City)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Param_City> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Param_City> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Param_City> modelList = new List<Garfield.Model.Param_City>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Param_City model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Param_City();

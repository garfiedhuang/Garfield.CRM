...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.hr_department dal=new Garfield.DAL.hr_department();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.hr_department GetModelByCache(int id)
		{
			...
			return (Garfield.Model.hr_department)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.hr_department> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.hr_department> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.hr_department> modelList = new List<Garfield.Model.hr_department>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.hr_department model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.hr_department();

...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Personal_Calendar dal=new Garfield.DAL.Personal_Calendar();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Personal_Calendar GetModelByCache(int Id)
		{
			...
			return (Garfield.Model.Personal_Calendar)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Personal_Calendar> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Personal_Calendar> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Personal_Calendar> modelList = new List<Garfield.Model.Personal_Calendar>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Personal_Calendar model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Personal_Calendar();

...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Sys_log_Err dal=new Garfield.DAL.Sys_log_Err();
		public Sys_log_Err()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Sys_log_Err GetModelByCache(int id)
		{
			...
			return (Garfield.Model.Sys_log_Err)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_log_Err> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_log_Err> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Sys_log_Err> modelList = new List<Garfield.Model.Sys_log_Err>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Sys_log_Err model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Sys_log_Err();

...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Param_SysParam_Type dal=new Garfield.DAL.Param_SysParam_Type();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Param_SysParam_Type GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			...
			return (Garfield.Model.Param_SysParam_Type)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Param_SysParam_Type> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Param_SysParam_Type> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Param_SysParam_Type> modelList = new List<Garfield.Model.Param_SysParam_Type>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Param_SysParam_Type model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Param_SysParam_Type();

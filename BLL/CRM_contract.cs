...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.CRM_contract dal=new Garfield.DAL.CRM_contract();
		public CRM_contract()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.CRM_contract GetModelByCache(int id)
		{
			...
			return (Garfield.Model.CRM_contract)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_contract> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_contract> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.CRM_contract> modelList = new List<Garfield.Model.CRM_contract>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.CRM_contract model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.CRM_contract();

...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.CRM_product dal=new Garfield.DAL.CRM_product();
		public CRM_product()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.CRM_product GetModelByCache(int product_id)
		{
			...
			return (Garfield.Model.CRM_product)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.CRM_product> GetModelList(string strWhere)
		{

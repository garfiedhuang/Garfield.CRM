...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Param_SysParam dal=new Garfield.DAL.Param_SysParam();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Param_SysParam GetModelByCache(int id)
		{
			...
			return (Garfield.Model.Param_SysParam)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Param_SysParam> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Param_SysParam> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Param_SysParam> modelList = new List<Garfield.Model.Param_SysParam>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Param_SysParam model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Param_SysParam();

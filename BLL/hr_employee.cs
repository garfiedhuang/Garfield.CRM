...
namespace Garfield.BLL
{
    ...
    {
        private readonly Garfield.DAL.hr_employee dal = new Garfield.DAL.hr_employee();
        public hr_employee()
        { }
        #region  Method
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Garfield.Model.hr_employee GetModelByCache(int ID)
        {
            ...
            return (Garfield.Model.hr_employee)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Garfield.Model.hr_employee> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Garfield.Model.hr_employee> DataTableToList(DataTable dt)
        {
            List<Garfield.Model.hr_employee> modelList = new List<Garfield.Model.hr_employee>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Garfield.Model.hr_employee model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Garfield.Model.hr_employee();

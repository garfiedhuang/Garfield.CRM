...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.Sys_role dal=new Garfield.DAL.Sys_role();
		public Sys_role()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.Sys_role GetModelByCache(int RoleID)
		{
			...
			return (Garfield.Model.Sys_role)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.Sys_role> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.Sys_role> modelList = new List<Garfield.Model.Sys_role>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.Sys_role model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.Sys_role();

...
namespace Garfield.BLL
{
	...
	{
		private readonly Garfield.DAL.hr_post dal=new Garfield.DAL.hr_post();
		public hr_post()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Garfield.Model.hr_post GetModelByCache(int post_id)
		{
			...
			return (Garfield.Model.hr_post)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.hr_post> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Garfield.Model.hr_post> DataTableToList(DataTable dt)
		{
			List<Garfield.Model.hr_post> modelList = new List<Garfield.Model.hr_post>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Garfield.Model.hr_post model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Garfield.Model.hr_post();
